...
class TestKeyPresses(BaseTest):
	...
	def get_result_text(self):
		return self.page.locator('#result').text_content()[13:]

	def test_all_keys(self):
		for key, value in self.PLAYWRIGHT_KEYS.items():
			self.page.locator('#target').press(key)
			assert self.get_result_text() == value
